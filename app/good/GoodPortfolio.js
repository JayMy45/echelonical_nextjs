...
export default function GoodPortfolio() {
    return (
        <>
            <div className="grid grid-cols-2 gap-x-7 max-w-xl  overflow-hidden mx-auto mt-10 p-4">
                ...
                <div className="border-2 rounded-lg bg-white shadow-lg p-3">
                    <Link className="" href="/pages/Done">
                        ...
                        />
                        <span className="bg-gray-200 p-1 text-gray-700 mb-5 ml-4 rounded-lg font-bold" >
                            Demo
                        </span>
                    </Link>
                </div>
