                    ...
                    <div className="lg:flex flex-col p-2 md:p-10 mt-3 md:mt-10">
                        <div className="flex flex-row justify-evenly p-2 mt-0 xl:mt-6 md:mb-4">
                            <div className="pl-7 md:pl-20">
                                {/* Javascript */}
                                <label className="text-xs md:text-base">JavaScript</label>
                                <div className="">
                            ...
                            <div>
                                {/* Python */}
                                <label className="text-xs md:text-base">Python</label>
                                <div className="">
                            ...
                            <div>
                                {/* SQL */}
                                <label className="pr-7 md:pr-20 text-xs md:text-base">SQL</label>
                        ...
                        <div className="flex flex-row justify-evenly p-2 md:mb-4">
                            <div className="pl-9 md:pl-20">
                                {/* ReactJs */}
                                <label className="text-xs md:text-base">ReactJs</label>
                                <div className="">
                            ...
                            <div>
                                {/* NextJs */}
                                <label className="text-xs md:text-base">NextJs</label>
                                <div className="">
                            ...
                            <div>
                                {/* Django */}
                                <label className="pr-7 md:pr-20 text-xs md:text-base">Django</label>
                                <div className="pr-7 md:pr-20">
                        ...
                        <div className="flex flex-row justify-evenly p-2 md:mb-4">
                            <div className="pl-7 md:pl-20">
                                {/* GitHub */}
                                <label className="text-xs md:text-base">GitHub</label>
                                <div className="">
                            ...
                            <div>
                                {/* Bulma */}
                                <label className="text-xs md:text-base">Bulma</label>
                                <div className="">
                            ...
                            <div>
                                {/* Tailwind */}
                                <label className="pr-7 md:pr-20 text-xs md:text-base">Tailwind</label>
                                <div className="pr-7 md:pr-20">
                        ...
                        <div className="flex flex-row justify-evenly p-2 md:mb-4">
                            <div className="pl-7 md:pl-20">
                                {/* HTML */}
                                <label className="text-xs md:text-base">HTML</label>
                                <div className="">
                            ...
                            <div>
                                {/* CSS */}
                                <label className="text-xs md:text-base">CSS</label>
                                <div className="">
                            ...
                            <div>
                                {/* Bootstrap */}
                                <label className="pr-7 md:pr-20 text-xs md:text-base">Bootstrap</label>
                                <div className="pr-7 md:pr-20">
