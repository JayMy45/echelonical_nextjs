    ...
    return (
        <>
            ...
            <div className="border-2 p-10 rounded-xl mb-5 mt-5" id="about">
                ...
                {/* portfolio container*/}
                <div className="mt-10 border-t-2 border-b-2" id="work">
                    <div className="mb-8">
